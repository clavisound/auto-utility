...
if __name__ == "__main__":
    ...
    if match_amount:
        data["ΠΟΣΟ ΠΛΗΡΩΜΗΣ"] = match_amount.group(1)
    ...
    if match_rf:
        data["Κωδικός ηλεκτρονικής πληρωμής"] = match_rf.group(1)
    ...
    if match_due_date:
        data["ΕΞΟΦΛΗΣΗ ΕΩΣ"] = match_due_date.group(1)
    ...
    if match_next_reading:
        data["Επόμενη καταμέτρηση"] = match_next_reading.group(1)
